...
export function Informations_psi() {
    return(
    <div className="bg-primary-300 h-screen w-screen flex flex-col items-center max-md:justify-center scrollbar-thin max-md:overflow-x-hidden max-md:overflow-y-visible max-md:h-full overflow-x-hidden">
