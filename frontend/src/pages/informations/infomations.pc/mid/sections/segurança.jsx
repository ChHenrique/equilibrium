...
export function Segurança(){
    return(
        <div className="w-[17vw] h-[80vh] bg-white mr-auto rounded-lg flex flex-col items-center max-md:hidden max-lg:h-[70%] max-lg:w-[25%] max-xl:h-[100%] max-2xl:max-h-[640px]">
