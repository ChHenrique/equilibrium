  ...
  return (
    ...
    <div className="w-full h-full flex items-center flex-col bg-primary-300">
      <div className="w-[95%] h-16 flex justify-end  m-4">
        ...
        <input type="text" className="w-1/3 max-md:w-full h-12 max-md:h-10 rounded-xl  bg-secondary-100 placeholder: text-primary-700 placeholder:p-2  border-none outline-1 outline-slate-300 p-2 placeholder-primary-700" placeholder="Pesquisar..." value={value} onChange={pegavalor} />
        <button className=" h-12 aspect-square rounded-xl bg-secondary-100 items-center justify-center flex ml-2 text-primary-700 duration-300 transition hover:bg-slate-300">
