...
export const Form = forwardRef(({ errors = {}, setErrors }, ref) => {
    ...
    return (
        <article className="flex flex-col justify-center items-center p-5 w-full max-w-4xl h-auto font-satoshi-Regular max-md:-translate-y-4 max-2xl:p-0">
            <form ref={ref} onSubmit={handleSubmit} className="w-4/6 max-w-1xl h-auto mt-12 ml-5 max-md:w-full space-y-6 max-xl:mt-12 max-2xl:mt-6 max-2xl:space-y-3 max-md:space-y-7 max-md:ml-9 max-lg:space-y-10 max-xl:space-y-8">
                <Name 
