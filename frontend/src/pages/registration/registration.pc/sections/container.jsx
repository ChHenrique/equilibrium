...
export function Container() {
    ...
    return (
        <div id = "conteiner" className= "bg-white flex-col flex items-center p-0 h-[85vh] w-[65vw] relative rounded-[10px] max-md:w-[95vw] max-2xl:h-[90vh] max-lg:h-[70vh] max-lg:w-[90vw] max-xl:h-[95vh] max-xl:w-[80vw] max-md:max-h-[480px] max-lg:max-h-[790px] max-2xl:max-h-[650px]">
            <Header />
