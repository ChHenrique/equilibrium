    ...
    return (
        <footer className="flex flex-col justify-center items-center mb-20">
            <button
                type="button"
                onClick={handleClick}
                className="bg-[#3B82F6] text-white border border-[#3B82F6] w-[350px] h-[35px] rounded-[10px] font-satoshi font-extrabold text-[17px] mt-[30px] hover:bg-[#1c3b79] transition-all duration-200 hover:rounded-[15px] mr-1 max-sm:w-[180px] max-sm:mt-10"
            >
                Entrar
            </button>
        </footer>
