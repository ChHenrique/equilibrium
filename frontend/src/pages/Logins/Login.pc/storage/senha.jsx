        ...
        <div className="flex flex-col ml-1.9 p-4 mb-2">
            ...
            <div className="grid grid-place-items">
                ...
                <div className="w-full flex items-center justify-between mt-2">
                    <Link to="/registro/paciente" className="text-[#465A7F] font-satoshi-bold text-[15px] hover:text-[#8cb3ff] max-md:text-[11px]">
                        Não tenho conta
                    </Link>
                    <a href="/login/esquecisenha" className="text-[#465A7F] font-satoshi-bold text-[15px] hover:text-[#8cb3ff] max-md:text-[11px]">
                        Esqueci minha senha
                    </a>
                </div>
            </div>
