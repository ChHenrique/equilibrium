...
export function Psicologo({nome,foto,tempConsulta}) {
    return(
        <div className="w-[75vw] h-auto bg-[#F1F5F9] rounded-2xl flex flex-col md:flex-row items-center p-4 md:p-6">
                ...
                <aside className="flex-shrink-0 mt-auto ml-auto">
                    <button className="w-full max-w-xs md:w-[14vw] h-[4vh] bg-[#3B82F6] text-white rounded-lg font-poppins border border-[#85c9cd] hover:bg-[#24989e] transition-all 
                    duration-700 ">
                        Agendar consulta
                    </button>
                </aside>
