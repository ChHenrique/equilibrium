export function Card({ title, text, imageUrl }) {
  return (
    <div
      key={title}
      className="min-w-60 max-w-80 h-[24rem] bg-white flex justify-center items-center flex-col rounded-2xl p-4 transition ease-out duration-500 card-active scale-95 opacity-70"
      id="card1"
    >
