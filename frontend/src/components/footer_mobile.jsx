...

    {
        ...
        img: (
            <svg width="30" height="28" viewBox="0 0 30 28" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path d="M25.2663 14C26.0513 14 26.6948 13.3621 26.619 12.5808C26.399 10.3134 25.6541 8.12896 24.4406 6.22202C22.9755 3.91973 20.8931 2.12532 18.4568 1.06569C16.0204 0.00606593 13.3395 -0.271181 10.7531 0.269012C8.16672 0.809205 5.79094 2.14258 3.92624 4.10051C2.06154 6.05845 0.791668 8.55301 0.277198 11.2687C-0.237271 13.9845 0.0267732 16.7994 1.03594 19.3576C2.04511 21.9157 3.75408 24.1022 5.94673 25.6406C7.77449 26.9229 9.86983 27.7068 12.0441 27.9323C12.7651 28.007 13.3543 27.4124 13.3543 26.6876C13.3543 25.9627 12.762 25.3837 12.0499 25.2482C10.4372 24.9415 8.88731 24.1138 7.52608 23.1587C5.80091 21.9484 4.45631 20.228 3.6623 18.2153C2.8683 16.2026 2.66055 13.9878 3.06533 11.8511C3.47011 9.71434 4.46924 7.75164 5.93637 6.21115C7.40351 4.67066 9.27275 3.62157 11.3077 3.19655C13.3427 2.77153 15.452 2.98967 17.3689 3.82337C19.2858 4.65708 20.9242 6.06891 22.0769 7.88034C22.9779 9.29609 23.5505 10.9062 23.7577 12.5822C23.854 13.3613 24.4813 14 25.2663 14Z" fill="#8CB3FF" />
                <path d="M12.6665 16.1L12.6665 6.29997" stroke="#8CB3FF" stroke-width="2.5" stroke-linecap="round" />
                <path d="M12.6665 16.1H17.9998" stroke="#8CB3FF" stroke-width="2.5" stroke-linecap="round" />
                <path d="M25.3447 14.7095L28.0002 11.2" stroke="#8CB3FF" stroke-width="3" stroke-linecap="round" />
                <path d="M24.9399 14.3908L22.0002 11.9" stroke="#8CB3FF" stroke-width="3" stroke-linecap="round" />
            </svg>
        )
    },
...
export function Footer_Mobile() {
    ...
    return (
            <div className="flex flex-col justify-center items-center space-y-2 bg-slate-50 w-[100%] rounded-tr-2xl rounded-tl-2xl p-2 absolute bottom-0">
                ...
                <div className="bg-primary-800 w-fit rounded-2xl">
                    <svg width="96" height="6" viewBox="0 0 96 6" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <rect width="96" height="6" rx="3" fill="#355081" />
                    </svg>
                </div>
